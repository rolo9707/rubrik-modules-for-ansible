...
options:
  aws_bucket_name:
    description:
      ...
      - The bucket name will  have all whitespace removed and all letters lowercased.
    required: true
    type: str
  aws_region:
    description:
  ...
  archive_name:
    description:
      - The name of the archive location used in the Rubrik GUI.
    required: false
    type: str
  storage_class:
    description:
...
def main():
    ...
    argument_spec = dict(
        ...
        aws_region=dict(required=False, type='str', choices=[
            "ap-south-1",
            "ap-northeast-2",
            "ap-southeast-1",
            "ap-southeast-2",
